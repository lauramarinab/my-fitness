...
import { workoutPlanTwo } from "../../data/workoutPlanTwo";
  ...
  return (
    <PageCard>
      <PageHeading>
        ...
        <p>• cinque minuti di camminata in pendenza sul tapis roulant, senza reggerti con le mani (no corsa)</p>
        <p>• esegui esercizi di mobilita per la parte interessata, a corpo libero (lavoro di circa 5/6 minuti)</p>
      </PageHeading>

      <SectionGrid>
        {workoutPlanTwo.map((session) => (
